#¡Crear aquí el editor de fotografías Editor simple!import os
...
btn_right.clicked.connect(workimage.rotard)
btn_left.clicked.connect(workimage.rotari)
btn_flip.clicked.connect(workimage.reflejo)
btn_sharp.clicked.connect(workimage.nitidezz)
